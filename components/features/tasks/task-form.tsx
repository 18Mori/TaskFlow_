...
const invalidInputClasses =
  "h-10 w-full rounded-md border border-rose-500/50 bg-zinc-900 px-3 text-sm text-zinc-200 placeholder:text-zinc-600 focus:border-rose-500 focus:outline-none focus:ring-1 focus:ring-rose-500 sm:h-9";
